            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:yugalkaushik@gmail.com" className="text-gray-600 hover:text-black transition-colors">
                    yugalkaushik@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <a href="https://linkedin.com/in/yugalkaushik" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-black transition-colors">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <a href="https://github.com/yugalkaushik" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-black transition-colors">
